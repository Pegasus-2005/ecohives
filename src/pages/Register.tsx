...
// The relative path to your image in the assets folder
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center lg:justify-end overflow-hidden">
      {/* Background Image Container - Crisp with subtle 2px blur */}
      <div 
      ...
      {/* Bright/Whitish Gradient Overlay - Shows image clearly on left, white glow on right */}
